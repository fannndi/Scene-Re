...
public class FastBlurUtility {
    ...
    /**
     * Returns a blurred background image
     *
     * @param activity the activity whose background is blurred
    ...
    // Measured: RenderScript blur performs worse in practice...
    private static Bitmap blur(Bitmap bitmap, Context context) {
        ...
        Allocation allIn = Allocation.createFromBitmap(rs, bitmap); // Allocate the input memory
        Allocation allOut = Allocation.createFromBitmap(rs, output); // Allocate the output memory
     ...
     * Takes a screenshot
     *
     * @param activity the activity to screenshot
     ...
     * Scales the image up
     *
     * @param bitmap the image to scale up
     ...
     *
     * @param bitmap the image to scale down
     ...
     * Blurs the image
     *
     * @param sentBitmap the image to blur
     * @param radius     blur strength
