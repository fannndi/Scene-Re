  ...
  case "$top_app" in
    ...
    "com.miHoYo.Yuanshen" | "com.miHoYo.ys.mi" | "com.miHoYo.ys.bilibili")
      ...
      if [[ "$action" = "powersave" ]]; then
        ...
        gpu_pl_up 2
        sched_limit 5000 0 5000 0
        set_cpu_freq 1708800 2500000 1843200 2750000
      elif [[ "$action" = "performance" ]]; then
        sched_boost 1 0
        stune_top_app 0 100
        gpu_pl_up 3
        sched_limit 5000 0 5000 0
        set_cpu_freq 1708800 2500000 1939200 2750000
      elif [[ "$action" = "fast" ]]; then
        sched_boost 1 0
        stune_top_app 0 100
        gpu_pl_up 3
        sched_limit 5000 0 10000 0
        set_cpu_freq 1708800 2500000 2169600 2750000
    ...
    "com.tencent.tmgp.sgame")
      ...
      if [[ "$action" = "powersave" ]]; then
        ...
        sched_boost 1 0
        stune_top_app 0 10
        set_cpu_freq 1708800 2500000 1555200 2750000
      elif [[ "$action" = "balance" ]]; then
        ...
        sched_boost 1 0
        stune_top_app 0 100
        set_cpu_freq 1708800 2500000 2208000 2750000
      elif [[ "$1" = "pedestal" ]]; then
        sched_boost 1 0
        stune_top_app 0 100
      fi
