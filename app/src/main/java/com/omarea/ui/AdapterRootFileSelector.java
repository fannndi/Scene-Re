...
public class AdapterRootFileSelector extends BaseAdapter {
    ...
    private boolean longClickDelete = false; // long-press option
            ...
            if (file.isDirectory()) {
                ...
                if (clickSelected) {
                    view.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            DialogHelper.Companion.animDialog(new AlertDialog.Builder(view.getContext()).setTitle("Select this file?")
