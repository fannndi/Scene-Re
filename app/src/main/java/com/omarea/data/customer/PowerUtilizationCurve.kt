...
class PowerUtilizationCurve(context: Context) : IEventReceiver {
    ...
    override fun onReceive(eventType: EventType, data: HashMap<String, Any>?) {
        when (eventType) {
            ...
            EventType.POWER_DISCONNECTED -> {
                // if the battery is nearly full or this session added more than 40, clear the records and restart the statistics
    ...
    private fun updateBatteryStatus() {
        ...
        GlobalStatus.updateBatteryTemperature() // trigger a temperature data refresh
    }
    ...
    private fun saveLog() {
        ...
        // do not record power usage within 5 minutes of boot; system services are busy right after boot and data would be inaccurate
